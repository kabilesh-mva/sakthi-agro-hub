    ...
    <section className="py-12 sm:py-16 bg-background overflow-visible">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 overflow-visible"
        >
            ...
            <div key={index} className="group relative overflow-visible">
              ...
              >
                <CardContent className="p-6 flex flex-col items-center text-center flex-grow relative overflow-visible transition-transform duration-300 group-hover:scale-104">
                  <div className={`absolute top-4 right-4 ${category.badgeColor} text-xs font-semibold px-3 py-1 rounded-full z-20`}>
                    {category.badge}
                  </div>
                  <div className="p-4 bg-green-50 rounded-full group-hover:bg-[#2E7D32] transition-colors duration-300 mb-4 relative z-10 flex items-center justify-center">
                    <category.icon className="h-10 w-10 text-[#2E7D32] group-hover:text-white transition-colors duration-300" />
                  </div>
        ...
        >
          <Button 
            size="sm" 
            className="bg-[#2E7D32] hover:bg-[#1B5E20] text-white px-8 py-3 rounded-lg transition" 
            asChild
          >
